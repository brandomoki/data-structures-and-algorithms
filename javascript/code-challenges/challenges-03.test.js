...
const typeNum = (arr) => {
  ...
  let newArry = arr.filter( number => ++number === number);
  return newArry;
  // Got this from: https://stackoverflow.com/questions/44628965/filtering-numbers-out-from-an-array
};
...
const oddValues = (arr) => {
  let newArry = arr.filter(value => value % 2);
  return newArry;
