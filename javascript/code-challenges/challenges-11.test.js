...
// Notes*************************************** This is how its done use this as reference in the future********************************
Object.entries(bob)
0: (2) ['name', 'bob']
1: (2) ['age', 32]
iterate through return - pull out those elements in each array
.join -> array method, join all the elements in an array and return a string based on what it joins to
...
//************************3, [[1, 3, 5, 7, 9], [5, 5, 5], [1, 2, 3]] -> return 2*******************************************************

ues flat() to remove the nested array situation
once I have one array of numbers -> to start iterating through the array
compare that if the numbers match, increment my counter..
filter is going to return me an array of elements that pass a test... return filtyered array length
------------------------------------------------------------------------------------------------ */
...
*********************************************************************************************************************************************
use flat to get one array of all numbers [1, 2, 3, 4, 5, 6, 7, 2, 4, 5, 7, 9, 2, 3, 6,]
use reduce to add all numbers that are in the array that will return my reduced value
------------------------------------------------------------------------------------------------ */
...
inner loop:
1st - remove elements that are not numbers and not devisible by five - filter return me an array of numbers and numbers that are devisible by 5. typrof === 'number' && % 5
...
// once I have those specific objs then I am going to pull the values from the name property -> map through that array of objs and only return person.name -> ['Luke Skywalker and Darth Vader and Leia Organa']
//.join array -> string
...
iterate through that array objects
look at the height of each personObj
compare it to the next persons height
